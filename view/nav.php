	...
	<div class="container">
		<div class="site-navigation">
			...
			<ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
				...
				<li><a href="http://localhost/pocheng/tokyo_restaurant/view/restaurant_search.php?&area=all&category=all&price_range=all&page=1">搜尋餐廳</a></li>
				...
				<li><a href="http://localhost/pocheng/tokyo_restaurant/view/admin.php?cate=edit&page=1">管理後台</a></li>
